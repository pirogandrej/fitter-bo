<section class="blog-area section">
    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div style="background-color: white;height: 100px;width: 100%;margin-bottom: 20px;">
                <h3 class="title" style="color:blue;padding: 2% 0 0% 0% ;">
                    {{--<p><b>{{ $category_full['title']  }}</b></p>--}}
                   <b> {{ $category_full['title']  }} </b>
                </h3>
            </div>
            <br>
            ...
            <div style="background-color: white;padding: 5%;text-align: left;">
