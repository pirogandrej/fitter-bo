...
@section('content')
    ...
    <form id="admin_change_category_form" class="form-horizontal" data-toggle="validator" novalidate="true" method="post" action="{{ route('admin_edit_category_form')}}" enctype="multipart/form-data">
            ...
            <div class="white-box">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-12">
                        ...
                        <input type="file" name="image" class="dropify" data-max-file-size="2M" data-height="300" data-default-file="{{ $post['category_image_url'] }}" value="{{ $post['image'] }}"/>

                        <input type="hidden" name="latest_image" value="{{ $post['image'] }}" />
