...
@section('content')
    ...
    <form id="change_post" class="form-horizontal" data-toggle="validator" novalidate="true" method="post" action="{{ route('fit_update_post')}}" enctype="multipart/form-data">
            ...
            <div class="white-box">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-12">
                        ...
                        <textarea name="text" class="form-control my-editor" required>{!! $post['text'] !!}</textarea>
                        <script>
                            var editor_config = {
                                path_absolute : "/",
